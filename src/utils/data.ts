...
export const FCHV_COUNSELING: FchvCounselingField[] = [
  ...
  },
  {
    ...
    number: true,
    name: false,
    en: "Number of patients referred during first aid",
    ne: "प्राथमिक उपचारको क्रममा प्रेषण गरेको बिरामीहरूको संख्या",
  },
  {
    key: "first_aid_referred_names",
    number: false,
    name: true,
    en: "Names of patients referred during first aid",
    ne: "प्राथमिक उपचारको क्रममा प्रेषण गरिएका बिरामीहरूको नाम",
  },
  {
  ...
  },
  {
    ...
    number: true,
    name: false,
    en: "Number of times you provided health education on NCD risk factors and prevention",
    ne: "नसर्ने रोगका जोखिम र रोकथाम सम्बन्धी स्वास्थ्य शिक्षा दिएको पटक",
  },
  {
